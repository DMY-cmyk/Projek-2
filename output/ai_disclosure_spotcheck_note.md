...
## Usage
- Fill `ai_keyword_hits_auto` from text-mining output.
- Fill `ai_keyword_hits_manual` from manual read.
- Set `match_flag` to 1 if aligned, else 0.
- Record discrepancy in `reviewer_note`.
